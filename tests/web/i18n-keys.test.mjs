...
// Keys added in the v1.5.0 release (7 new tool tabs - Prilepin's table/INOL,
// meet attempt selection, skinfold body-fat, tonnage, e1RM PR check, gym
// milestone "clubs", and the muscle-gain-rate estimate - plus their 6 new
// glossary entries) - shipped English-complete per the same scope decision
// NEW_IN_1_3_0's comment documents (translate as a tracked fast-follow, not
// a release blocker). Computed via `git diff` against en.js at release time,
// same mechanism as NEW_IN_1_3_0/NEW_IN_1_4_0.
const NEW_IN_1_5_0 = new Set([
  "attempts.amrapRepsDecAria",
  "attempts.amrapRepsIncAria",
  "attempts.amrapRepsLabel",
  "attempts.amrapWeightDecAria",
  "attempts.amrapWeightIncAria",
  "attempts.amrapWeightLabel",
  "attempts.disclaimer",
  "attempts.goalDecAria",
  "attempts.goalIncAria",
  "attempts.goalLabel",
  "attempts.heading",
  "attempts.liftLabel",
  "attempts.liftPlaceholder",
  "attempts.mode.amrap",
  "attempts.mode.goal",
  "attempts.modeLabel",
  "attempts.result.attemptDetail",
  "attempts.result.derivedHint",
  "attempts.result.incrementNote",
  "attempts.result.opener",
  "attempts.result.second",
  "attempts.result.third",
  "attempts.result.thirdDetail",
  "attempts.result.unitHeading",
  "attempts.sourceNote",
  "clubs.benchDecAria",
  "clubs.benchIncAria",
  "clubs.benchLabel",
  "clubs.caveat",
  "clubs.deadliftDecAria",
  "clubs.deadliftIncAria",
  "clubs.deadliftLabel",
  "clubs.disclaimer",
  "clubs.heading",
  "clubs.ohpDecAria",
  "clubs.ohpIncAria",
  "clubs.ohpLabel",
  "clubs.ohpPlaceholder",
  "clubs.result.achieved",
  "clubs.result.club.1000",
  "clubs.result.club.1-plate",
  "clubs.result.club.2-plate",
  "clubs.result.club.3-plate",
  "clubs.result.club.4-plate",
  "clubs.result.remaining",
  "clubs.result.tableClub",
  "clubs.result.tableThreshold",
  "clubs.result.twoThreeFourLabel",
  "clubs.result.twoThreeFourNo",
  "clubs.result.twoThreeFourYes",
  "clubs.squatDecAria",
  "clubs.squatIncAria",
  "clubs.squatLabel",
  "gainrate.bodyweightDecAria",
  "gainrate.bodyweightIncAria",
  "gainrate.bodyweightLabel",
  "gainrate.disclaimer",
  "gainrate.heading",
  "gainrate.informationalNote",
  "gainrate.level.advanced",
  "gainrate.level.beginner",
  "gainrate.level.intermediate",
  "gainrate.levelLabel",
  "gainrate.result.aragonHeading",
  "gainrate.result.aragonMonthly",
  "gainrate.result.aragonSourceLabel",
  "gainrate.result.aragonYearly",
  "gainrate.result.mcdonaldHeading",
  "gainrate.result.mcdonaldYear1",
  "gainrate.result.mcdonaldYear2",
  "gainrate.result.mcdonaldYear3",
  "gainrate.result.mcdonaldYear4Plus",
  "gainrate.result.mcdonaldYear4PlusNote",
  "glossary.terms.attemptSelection.plain",
  "glossary.terms.attemptSelection.technical",
  "glossary.terms.attemptSelection.term",
  "glossary.terms.e1rmPr.plain",
  "glossary.terms.e1rmPr.technical",
  "glossary.terms.e1rmPr.term",
  "glossary.terms.inol.plain",
  "glossary.terms.inol.technical",
  "glossary.terms.inol.term",
  "glossary.terms.prilepin.plain",
  "glossary.terms.prilepin.technical",
  "glossary.terms.prilepin.term",
  "glossary.terms.skinfold.plain",
  "glossary.terms.skinfold.technical",
  "glossary.terms.skinfold.term",
  "glossary.terms.tonnage.plain",
  "glossary.terms.tonnage.technical",
  "glossary.terms.tonnage.term",
  "prcheck.disclaimer",
  "prcheck.heading",
  "prcheck.mode.onerm",
  "prcheck.mode.set",
  "prcheck.modeLabel",
  "prcheck.newRepsDecAria",
  "prcheck.newRepsIncAria",
  "prcheck.newRepsLabel",
  "prcheck.newWeightDecAria",
  "prcheck.newWeightIncAria",
  "prcheck.newWeightLabel",
  "prcheck.previousOnermDecAria",
  "prcheck.previousOnermIncAria",
  "prcheck.previousOnermLabel",
  "prcheck.previousRepsDecAria",
  "prcheck.previousRepsIncAria",
  "prcheck.previousRepsLabel",
  "prcheck.previousWeightDecAria",
  "prcheck.previousWeightIncAria",
  "prcheck.previousWeightLabel",
  "prcheck.result.isPr",
  "prcheck.result.newLabel",
  "prcheck.result.notPr",
  "prcheck.result.previousLabel",
  "prcheck.sourceNote",
  "prilepin.caveat",
  "prilepin.disclaimer",
  "prilepin.heading",
  "prilepin.inol.weekly.brutal",
  "prilepin.inol.weekly.easy",
  "prilepin.inol.weekly.insane",
  "prilepin.inol.weekly.tough",
  "prilepin.inol.workout.brutal",
  "prilepin.inol.workout.optimal",
  "prilepin.inol.workout.tough",
  "prilepin.inol.workout.under",
  "prilepin.pctDecAria",
  "prilepin.pctIncAria",
  "prilepin.pctLabel",
  "prilepin.repsDecAria",
  "prilepin.repsIncAria",
  "prilepin.repsLabel",
  "prilepin.result.inolHeading",
  "prilepin.result.inolValue",
  "prilepin.result.repsToOptimal",
  "prilepin.result.schemeHeading",
  "prilepin.result.schemeSummary",
  "prilepin.result.weeklyBandLabel",
  "prilepin.result.workoutBandLabel",
  "prilepin.result.zoneHeading",
  "prilepin.result.zoneOptimal",
  "prilepin.result.zoneRepsPerSet",
  "prilepin.result.zoneTotalReps",
  "prilepin.setsDecAria",
  "prilepin.setsIncAria",
  "prilepin.setsLabel",
  "prilepin.sourceNote",
  "prilepin.verdict.optimal",
  "prilepin.verdict.over",
  "prilepin.verdict.under",
  "prilepin.warn.repsPerSetOutOfRange",
  "skinfold.ageDecAria",
  "skinfold.ageIncAria",
  "skinfold.ageLabel",
  "skinfold.disclaimer",
  "skinfold.heading",
  "skinfold.method.3site",
  "skinfold.method.7site",
  "skinfold.methodLabel",
  "skinfold.result.bodyfatLabel",
  "skinfold.result.densityLabel",
  "skinfold.result.sitesHeading",
  "skinfold.result.sumLabel",
  "skinfold.sex.female",
  "skinfold.sex.male",
  "skinfold.sexLabel",
  "skinfold.site.abdominalDecAria",
  "skinfold.site.abdominalIncAria",
  "skinfold.site.abdominalLabel",
  "skinfold.site.axillaDecAria",
  "skinfold.site.axillaIncAria",
  "skinfold.site.axillaLabel",
  "skinfold.site.chestDecAria",
  "skinfold.site.chestIncAria",
  "skinfold.site.chestLabel",
  "skinfold.site.subscapularDecAria",
  "skinfold.site.subscapularIncAria",
  "skinfold.site.subscapularLabel",
  "skinfold.site.suprailiacDecAria",
  "skinfold.site.suprailiacIncAria",
  "skinfold.site.suprailiacLabel",
  "skinfold.site.thighDecAria",
  "skinfold.site.thighIncAria",
  "skinfold.site.thighLabel",
  "skinfold.site.tricepsDecAria",
  "skinfold.site.tricepsIncAria",
  "skinfold.site.tricepsLabel",
  "skinfold.sourceNote",
  "skinfold.warn.men3SiteAmbiguity",
  "tab.attempts",
  "tab.clubs",
  "tab.gainrate",
  "tab.prcheck",
  ...
  "tonnage.disclaimer",
  "tonnage.heading",
  "tonnage.result.averageIntensityHint",
  "tonnage.result.averageIntensityLabel",
  "tonnage.result.setPctTag",
  "tonnage.result.setRow",
  "tonnage.result.totalLabel",
  "tonnage.setsHint",
  "tonnage.setsLabel",
]);
...
for (const locale of LOCALES) {
  ...
  test(`${locale}.js: exports exactly the same key set as en.js`, async () => {
    ...
    // NEW_IN_1_3_0/NEW_IN_1_4_0/NEW_IN_1_5_0 keys may be absent (graceful
    // English fallback at runtime - see NEW_IN_1_3_0's own comment); every
    // OTHER en.js key is still required, same strict parity this test has
    // always enforced.
    const missing = [...EN_KEYS].filter(
      (k) => !localeKeys.has(k) && !NEW_IN_1_3_0.has(k) && !NEW_IN_1_4_0.has(k) && !NEW_IN_1_5_0.has(k)
    );
  ...
  test(`${locale}.js: every {placeholder} token matches en.js exactly, key-for-key`, async () => {
    ...
    for (const key of EN_KEYS) {
      // A NEW_IN_1_3_0/NEW_IN_1_4_0/NEW_IN_1_5_0 key the locale hasn't picked
      // up yet falls back to the English string wholesale (placeholders
      // included) at runtime, not a half-translated string with mismatched
      // tokens - only check it here once/if the locale actually defines it.
      if ((NEW_IN_1_3_0.has(key) || NEW_IN_1_4_0.has(key) || NEW_IN_1_5_0.has(key)) && !(key in dict)) continue;
